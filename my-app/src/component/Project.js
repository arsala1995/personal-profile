                        ...
                        <div className="row">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <a className="btn viewbtn rounded-pill shadow" href="https://link.springer.com/article/10.1007/s42835-020-00568-6#:~:text=With%20device%20selective%20power%2Dcut,with%20limited%20use%20of%20electricity" 
                    ...
                    <div className="card-deck">
                        <div className="card" style={{borderColor:'#f3e909'}} data-aos="fade-up">
                            ...
                            <div className="card-body">
                                ...
                                <a className="btn viewbtn rounded-pill shadow" href={face} target="_blank" style={{textDecoration:'none', width:'50%', marginTop:'68px'}}>
