                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                <p className="card-text resumeText">
                                    ...
                                    If you are interested, you can check out my <a className="glLink" href="https://github.com/arsala1995" target="_blank">github</a> and <a className="glLink" href="https://www.linkedin.com/in/sher-shah-arsalaie-1538061a4/" target="_blank">linkedIn</a> profile apart from this to get better understanding of the work that I do.
                                </p>
